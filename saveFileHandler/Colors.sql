-- FROM PRISMATIC WITH THESE ADDITIONS TO GET IT WORKING WITH PYTHON
CREATE TABLE Colors (
...
VALUES	('LEADER_ALEXANDER', 'Unique', 'COLOR_STANDARD_WHITE_MD2', 'COLOR_SC_BRIGHT_YELLOW', 'COLOR_SC_DARK_GREECE_BLUE', 'COLOR_STANDARD_YELLOW_LT', 'COLOR_STANDARD_ORANGE_DK', 'COLOR_STANDARD_YELLOW_MD', 'COLOR_SC_DARK_CYAN', 'COLOR_SC_LIGHT_CYAN'),
		...
		('LEADER_CATHERINE_DE_MEDICI_ALT', 'Unique', 'COLOR_SC_LIGHT_PERSIMMON', 'COLOR_STANDARD_WHITE_LT', 'COLOR_STANDARD_BLUE_MD', 'COLOR_SC_BRIGHT_YELLOW', 'COLOR_STANDARD_WHITE_LT', 'COLOR_STANDARD_YELLOW_DK', 'COLOR_SC_GREECE_BLUE', 'COLOR_SC_BRIGHT_YELLOW'),
